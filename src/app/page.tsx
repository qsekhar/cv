        ...
        <Container>
          <div className={stylish.className}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <FadeInWhenVisible delay={1}><h1>Full Stack Developer</h1></FadeInWhenVisible>
              </div>
              ...
              <div className='col-span-2'>
                <FadeInWhenVisible delay={0}><span className='h1'>Subhra Sekhar</span></FadeInWhenVisible>
              </div>
              <div>
                <FadeInWhenVisible delay={0.5}><span className='h1'>Mukherjee</span></FadeInWhenVisible>
              </div>
