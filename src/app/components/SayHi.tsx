        ...
        <ReCaptchaProvider reCaptchaKey={capchaKey}>
            <div className="flex flex-col items-center" id="sayhi">
                ...
                <p className="text-lg pb-2">
                    Are you looking for expert advice but not sure where to
                    start? I'm offering a free consultation to help you navigate
                    your next steps with confidence. Whether you're facing a
                    tough decision, planning a new project, or just need some
                    guidance, I am here to assist you—at no cost!
                </p>
